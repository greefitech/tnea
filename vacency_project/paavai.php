...
<form action="save_data.php" id="save_data" method="POST">
	<input type="text" name="college" value="PAAVAI">
	...
	<input type="text" name="chemical_department" id="chemical_department">
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		//Agri
		var oc_agri_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(3)").html();
		var bcm_agri_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(5)").html();
		var bc_agri_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(7)").html();
		var mbc_agri_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(9)").html();
		var sca_agri_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(11)").html();
		var sc_agri_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(13)").html();
		var st_agri_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(15)").html();

		$("#agri_department").val(oc_agri_engineering_value+"|"+bcm_agri_engineering_value+"|"+bc_agri_engineering_value+"|"+mbc_agri_engineering_value+"|"+sca_agri_engineering_value+"|"+sc_agri_engineering_value+"|"+st_agri_engineering_value);

		//CIVIL_ex
		var oc_civil_ex_engineering_value = $("table > tbody tr:nth-child(10) > td:nth-child(3)").html();
		var bcm_civil_ex_engineering_value = $("table > tbody tr:nth-child(10) > td:nth-child(5)").html();
		var bc_civil_ex_engineering_value = $("table > tbody tr:nth-child(10) > td:nth-child(7)").html();
		var mbc_civil_ex_engineering_value = $("table > tbody tr:nth-child(10) > td:nth-child(9)").html();
		var sca_civil_ex_engineering_value = $("table > tbody tr:nth-child(10) > td:nth-child(11)").html();
		var sc_civil_ex_engineering_value = $("table > tbody tr:nth-child(10) > td:nth-child(13)").html();
		var st_civil_ex_engineering_value = $("table > tbody tr:nth-child(10) > td:nth-child(15)").html();
		...
		//CIVIL
		var oc_civil_engineering_value = $("table > tbody tr:nth-child(12) > td:nth-child(3)").html();
		var bcm_civil_engineering_value = $("table > tbody tr:nth-child(12) > td:nth-child(5)").html();
		var bc_civil_engineering_value = $("table > tbody tr:nth-child(12) > td:nth-child(7)").html();
		var mbc_civil_engineering_value = $("table > tbody tr:nth-child(12) > td:nth-child(9)").html();
		var sca_civil_engineering_value = $("table > tbody tr:nth-child(12) > td:nth-child(11)").html();
		var sc_civil_engineering_value = $("table > tbody tr:nth-child(12) > td:nth-child(13)").html();
		var st_civil_engineering_value = $("table > tbody tr:nth-child(12) > td:nth-child(15)").html();
		...
		//Chemical
		var oc_chemical_engineering_value = $("table > tbody tr:nth-child(14) > td:nth-child(3)").html();
		var bcm_chemical_engineering_value = $("table > tbody tr:nth-child(14) > td:nth-child(5)").html();
		var bc_chemical_engineering_value = $("table > tbody tr:nth-child(14) > td:nth-child(7)").html();
		var mbc_chemical_engineering_value = $("table > tbody tr:nth-child(14) > td:nth-child(9)").html();
		var sca_chemical_engineering_value = $("table > tbody tr:nth-child(14) > td:nth-child(11)").html();
		var sc_chemical_engineering_value = $("table > tbody tr:nth-child(14) > td:nth-child(13)").html();
		var st_chemical_engineering_value = $("table > tbody tr:nth-child(14) > td:nth-child(15)").html();

		$("#chemical_department").val(oc_chemical_engineering_value+"|"+bcm_chemical_engineering_value+"|"+bc_chemical_engineering_value+"|"+mbc_chemical_engineering_value+"|"+sca_chemical_engineering_value+"|"+sc_chemical_engineering_value+"|"+st_chemical_engineering_value);

		//CSE
		var oc_cse_engineering_value = $("table > tbody tr:nth-child(16) > td:nth-child(3)").html();
		var bcm_cse_engineering_value = $("table > tbody tr:nth-child(16) > td:nth-child(5)").html();
		var bc_cse_engineering_value = $("table > tbody tr:nth-child(16) > td:nth-child(7)").html();
		var mbc_cse_engineering_value = $("table > tbody tr:nth-child(16) > td:nth-child(9)").html();
		var sca_cse_engineering_value = $("table > tbody tr:nth-child(16) > td:nth-child(11)").html();
		var sc_cse_engineering_value = $("table > tbody tr:nth-child(16) > td:nth-child(13)").html();
		var st_cse_engineering_value = $("table > tbody tr:nth-child(16) > td:nth-child(15)").html();
		...
		//ECE
		var oc_ece_engineering_value = $("table > tbody tr:nth-child(18) > td:nth-child(3)").html();
		var bcm_ece_engineering_value = $("table > tbody tr:nth-child(18) > td:nth-child(5)").html();
		var bc_ece_engineering_value = $("table > tbody tr:nth-child(18) > td:nth-child(7)").html();
		var mbc_ece_engineering_value = $("table > tbody tr:nth-child(18) > td:nth-child(9)").html();
		var sca_ece_engineering_value = $("table > tbody tr:nth-child(18) > td:nth-child(11)").html();
		var sc_ece_engineering_value = $("table > tbody tr:nth-child(18) > td:nth-child(13)").html();
		var st_ece_engineering_value = $("table > tbody tr:nth-child(18) > td:nth-child(15)").html();
		...
		//EEE
		var oc_eee_engineering_value = $("table > tbody tr:nth-child(20) > td:nth-child(3)").html();
		var bcm_eee_engineering_value = $("table > tbody tr:nth-child(20) > td:nth-child(5)").html();
		var bc_eee_engineering_value = $("table > tbody tr:nth-child(20) > td:nth-child(7)").html();
		var mbc_eee_engineering_value = $("table > tbody tr:nth-child(20) > td:nth-child(9)").html();
		var sca_eee_engineering_value = $("table > tbody tr:nth-child(20) > td:nth-child(11)").html();
		var sc_eee_engineering_value = $("table > tbody tr:nth-child(20) > td:nth-child(13)").html();
		var st_eee_engineering_value = $("table > tbody tr:nth-child(20) > td:nth-child(15)").html();
