...
<form action="save_data.php" id="save_data" method="POST">
	<input type="text" name="college" value="ANNAPOORNA">
	<?php 
	$department = array("automobile_department","civil_department","cse_department","ece_department","eee_department","mech_department" );
