...
<form action="save_data.php" id="save_data" method="POST">
	<input type="text" name="college" value="muthayammal1">
...
$(document).ready(function () {
		...
		var oc_ece_ex_engineering_value = $("table > tbody tr:nth-child(10) > td:nth-child(3)").html();
		var bcm_ece_ex_engineering_value = $("table > tbody tr:nth-child(10) > td:nth-child(5)").html();
		var bc_ece_ex_engineering_value = $("table > tbody tr:nth-child(10) > td:nth-child(7)").html();
		var mbc_ece_ex_engineering_value = $("table > tbody tr:nth-child(10) > td:nth-child(9)").html();
		var sca_ece_ex_engineering_value = $("table > tbody tr:nth-child(10) > td:nth-child(11)").html();
		var sc_ece_ex_engineering_value = $("table > tbody tr:nth-child(10) > td:nth-child(13)").html();
		var st_ece_ex_engineering_value = $("table > tbody tr:nth-child(10) > td:nth-child(15)").html();
