...
<form action="save_data.php" id="save_data" method="POST">
	<input type="text" name="college" value="M_KUMARASAMY">
	<?php 
	$department = array("civil_department","cse_department","ece_department","eee_department","eandi_department","it_ex_department","it_department","mech_department" );
