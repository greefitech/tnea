...
<form action="save_data.php" id="save_data" method="POST">
	<input type="text" name="college" value="Vivekanandha1">
	<input type="text" name="bio_department" id="bio_department">
...
$(document).ready(function () {
		...
		// bio
		var oc_bio_engineering_value = $("table > tbody tr:nth-child(6) > td:nth-child(3)").html();
		var bcm_bio_engineering_value = $("table > tbody tr:nth-child(6) > td:nth-child(5)").html();
		var bc_bio_engineering_value = $("table > tbody tr:nth-child(6) > td:nth-child(7)").html();
		var mbc_bio_engineering_value = $("table > tbody tr:nth-child(6) > td:nth-child(9)").html();
		var sca_bio_engineering_value = $("table > tbody tr:nth-child(6) > td:nth-child(11)").html();
		var sc_bio_engineering_value = $("table > tbody tr:nth-child(6) > td:nth-child(13)").html();
		var st_bio_engineering_value = $("table > tbody tr:nth-child(6) > td:nth-child(15)").html();

		$("#bio_department").val(oc_bio_engineering_value+"|"+bcm_bio_engineering_value+"|"+bc_bio_engineering_value+"|"+mbc_bio_engineering_value+"|"+sca_bio_engineering_value+"|"+sc_bio_engineering_value+"|"+st_bio_engineering_value);
