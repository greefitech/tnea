...
<form action="save_data.php" id="save_data" method="POST">
	<input type="text" name="college" value="Sengunthar1">
	<input type="text" name="cse_department" id="cse_department">
	<input type="text" name="ece_ex_department" id="ece_ex_department">
	...
	<input type="text" name="medical_department" id="medical_department">
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		//ECE EX
		var oc_ece_ex_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(3)").html();
		var bcm_ece_ex_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(5)").html();
		var bc_ece_ex_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(7)").html();
		var mbc_ece_ex_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(9)").html();
		var sca_ece_ex_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(11)").html();
		var sc_ece_ex_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(13)").html();
		var st_ece_ex_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(15)").html();

		$("#ece_ex_department").val(oc_ece_ex_engineering_value+"|"+bcm_ece_ex_engineering_value+"|"+bc_ece_ex_engineering_value+"|"+mbc_ece_ex_engineering_value+"|"+sca_ece_ex_engineering_value+"|"+sc_ece_ex_engineering_value+"|"+st_ece_ex_engineering_value);
		...
		//Medical
		var oc_medical_engineering_value = $("table > tbody tr:nth-child(16) > td:nth-child(3)").html();
		var bcm_medical_engineering_value = $("table > tbody tr:nth-child(16) > td:nth-child(5)").html();
		var bc_medical_engineering_value = $("table > tbody tr:nth-child(16) > td:nth-child(7)").html();
		var mbc_medical_engineering_value = $("table > tbody tr:nth-child(16) > td:nth-child(9)").html();
		var sca_medical_engineering_value = $("table > tbody tr:nth-child(16) > td:nth-child(11)").html();
		var sc_medical_engineering_value = $("table > tbody tr:nth-child(16) > td:nth-child(13)").html();
		var st_medical_engineering_value = $("table > tbody tr:nth-child(16) > td:nth-child(15)").html();

		$("#medical_department").val(oc_medical_engineering_value+"|"+bcm_medical_engineering_value+"|"+bc_medical_engineering_value+"|"+mbc_medical_engineering_value+"|"+sca_medical_engineering_value+"|"+sc_medical_engineering_value+"|"+st_medical_engineering_value);
