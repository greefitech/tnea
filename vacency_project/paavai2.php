...
<form action="save_data.php" id="save_data" method="POST">
	<input type="text" name="college" value="PAAVAI2">
...
$(document).ready(function () {
		...
		var oc_mechatronics_engineering_value = $("table > tbody tr:nth-child(14) > td:nth-child(3)").html();
		var bcm_mechatronics_engineering_value = $("table > tbody tr:nth-child(14) > td:nth-child(5)").html();
		var bc_mechatronics_engineering_value = $("table > tbody tr:nth-child(14) > td:nth-child(7)").html();
		var mbc_mechatronics_engineering_value = $("table > tbody tr:nth-child(14) > td:nth-child(9)").html();
		var sca_mechatronics_engineering_value = $("table > tbody tr:nth-child(14) > td:nth-child(11)").html();
		var sc_mechatronics_engineering_value = $("table > tbody tr:nth-child(14) > td:nth-child(13)").html();
		var st_mechatronics_engineering_value = $("table > tbody tr:nth-child(14) > td:nth-child(15)").html();
