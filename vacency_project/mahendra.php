...
<form action="save_data.php" id="save_data" method="POST">
	<input type="text" name="college" value="Mahendra">
	...
	<input type="text" name="mechandauto_department" id="mechandauto_department">
</form>
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		//IT
		var oc_it_engineering_value = $("table > tbody tr:nth-child(20) > td:nth-child(3)").html();
		var bcm_it_engineering_value = $("table > tbody tr:nth-child(20) > td:nth-child(5)").html();
		var bc_it_engineering_value = $("table > tbody tr:nth-child(20) > td:nth-child(7)").html();
		var mbc_it_engineering_value = $("table > tbody tr:nth-child(20) > td:nth-child(9)").html();
		var sca_it_engineering_value = $("table > tbody tr:nth-child(20) > td:nth-child(11)").html();
		var sc_it_engineering_value = $("table > tbody tr:nth-child(20) > td:nth-child(13)").html();
		var st_it_engineering_value = $("table > tbody tr:nth-child(20) > td:nth-child(15)").html();
		...
		//mechatronics
		var oc_mechatronics_engineering_value = $("table > tbody tr:nth-child(22) > td:nth-child(3)").html();
		var bcm_mechatronics_engineering_value = $("table > tbody tr:nth-child(22) > td:nth-child(5)").html();
		var bc_mechatronics_engineering_value = $("table > tbody tr:nth-child(22) > td:nth-child(7)").html();
		var mbc_mechatronics_engineering_value = $("table > tbody tr:nth-child(22) > td:nth-child(9)").html();
		var sca_mechatronics_engineering_value = $("table > tbody tr:nth-child(22) > td:nth-child(11)").html();
		var sc_mechatronics_engineering_value = $("table > tbody tr:nth-child(22) > td:nth-child(13)").html();
		var st_mechatronics_engineering_value = $("table > tbody tr:nth-child(22) > td:nth-child(15)").html();
		...
		//mech
		var oc_mech_engineering_value = $("table > tbody tr:nth-child(24) > td:nth-child(3)").html();
		var bcm_mech_engineering_value = $("table > tbody tr:nth-child(24) > td:nth-child(5)").html();
		var bc_mech_engineering_value = $("table > tbody tr:nth-child(24) > td:nth-child(7)").html();
		var mbc_mech_engineering_value = $("table > tbody tr:nth-child(24) > td:nth-child(9)").html();
		var sca_mech_engineering_value = $("table > tbody tr:nth-child(24) > td:nth-child(11)").html();
		var sc_mech_engineering_value = $("table > tbody tr:nth-child(24) > td:nth-child(13)").html();
		var st_mech_engineering_value = $("table > tbody tr:nth-child(24) > td:nth-child(15)").html();
		...
		//MECH and Automation
		var oc_mechandauto_engineering_value = $("table > tbody tr:nth-child(26) > td:nth-child(3)").html();
		var bcm_mechandauto_engineering_value = $("table > tbody tr:nth-child(26) > td:nth-child(5)").html();
		var bc_mechandauto_engineering_value = $("table > tbody tr:nth-child(26) > td:nth-child(7)").html();
		var mbc_mechandauto_engineering_value = $("table > tbody tr:nth-child(26) > td:nth-child(9)").html();
		var sca_mechandauto_engineering_value = $("table > tbody tr:nth-child(26) > td:nth-child(11)").html();
		var sc_mechandauto_engineering_value = $("table > tbody tr:nth-child(26) > td:nth-child(13)").html();
		var st_mechandauto_engineering_value = $("table > tbody tr:nth-child(26) > td:nth-child(15)").html();

		$("#mechandauto_department").val(oc_mechandauto_engineering_value+"|"+bcm_mechandauto_engineering_value+"|"+bc_mechandauto_engineering_value+"|"+mbc_mechandauto_engineering_value+"|"+sca_mechandauto_engineering_value+"|"+sc_mechandauto_engineering_value+"|"+st_mechandauto_engineering_value);
