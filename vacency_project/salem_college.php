...
<form action="save_data.php" id="save_data" method="POST">
	<input type="text" name="college" value="SALEM_COLLEGE">
	<?php 
	$department = array("bio_department","civil_department","cse_ex_department","cse_department","ece_department","eee_department","mech_department");
