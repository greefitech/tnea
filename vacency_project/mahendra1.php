...
<form action="save_data.php" id="save_data" method="POST">
	<input type="text" name="college" value="Mahendra1">
	...
	<input type="text" name="petrochemical_department" id="petrochemical_department">
</form>
...
$(document).ready(function () {
		...
		var oc_mech_engineering_value = $("table > tbody tr:nth-child(12) > td:nth-child(3)").html();
		var bcm_mech_engineering_value = $("table > tbody tr:nth-child(12) > td:nth-child(5)").html();
		var bc_mech_engineering_value = $("table > tbody tr:nth-child(12) > td:nth-child(7)").html();
		var mbc_mech_engineering_value = $("table > tbody tr:nth-child(12) > td:nth-child(9)").html();
		var sca_mech_engineering_value = $("table > tbody tr:nth-child(12) > td:nth-child(11)").html();
		var sc_mech_engineering_value = $("table > tbody tr:nth-child(12) > td:nth-child(13)").html();
		var st_mech_engineering_value = $("table > tbody tr:nth-child(12) > td:nth-child(15)").html();
		...
		var oc_petrochemical_engineering_value = $("table > tbody tr:nth-child(14) > td:nth-child(3)").html();
		var bcm_petrochemical_engineering_value = $("table > tbody tr:nth-child(14) > td:nth-child(5)").html();
		var bc_petrochemical_engineering_value = $("table > tbody tr:nth-child(14) > td:nth-child(7)").html();
		var mbc_petrochemical_engineering_value = $("table > tbody tr:nth-child(14) > td:nth-child(9)").html();
		var sca_petrochemical_engineering_value = $("table > tbody tr:nth-child(14) > td:nth-child(11)").html();
		var sc_petrochemical_engineering_value = $("table > tbody tr:nth-child(14) > td:nth-child(13)").html();
		var st_petrochemical_engineering_value = $("table > tbody tr:nth-child(14) > td:nth-child(15)").html();

		$("#petrochemical_department").val(oc_petrochemical_engineering_value+"|"+bcm_petrochemical_engineering_value+"|"+bc_petrochemical_engineering_value+"|"+mbc_petrochemical_engineering_value+"|"+sca_petrochemical_engineering_value+"|"+sc_petrochemical_engineering_value+"|"+st_petrochemical_engineering_value);
