...
<form action="save_data.php" id="save_data" method="POST">
	<input type="text" name="college" value="IRTT">
	<input type="text" name="automobile_ex_department" id="automobile_ex_department">
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		//Automobile EX
		var oc_automobile_ex_engineering_value = $("table > tbody tr:nth-child(6) > td:nth-child(3)").html();
		var bcm_automobile_ex_engineering_value = $("table > tbody tr:nth-child(6) > td:nth-child(5)").html();
		var bc_automobile_ex_engineering_value = $("table > tbody tr:nth-child(6) > td:nth-child(7)").html();
		var mbc_automobile_ex_engineering_value = $("table > tbody tr:nth-child(6) > td:nth-child(9)").html();
		var sca_automobile_ex_engineering_value = $("table > tbody tr:nth-child(6) > td:nth-child(11)").html();
		var sc_automobile_ex_engineering_value = $("table > tbody tr:nth-child(6) > td:nth-child(13)").html();
		var st_automobile_ex_engineering_value = $("table > tbody tr:nth-child(6) > td:nth-child(15)").html();

		$("#automobile_ex_department").val(oc_automobile_ex_engineering_value+"|"+bcm_automobile_ex_engineering_value+"|"+bc_automobile_ex_engineering_value+"|"+mbc_automobile_ex_engineering_value+"|"+sca_automobile_ex_engineering_value+"|"+sc_automobile_ex_engineering_value+"|"+st_automobile_ex_engineering_value);


		//Automobile
		var oc_automobile_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(3)").html();
		var bcm_automobile_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(5)").html();
		var bc_automobile_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(7)").html();
		var mbc_automobile_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(9)").html();
		var sca_automobile_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(11)").html();
		var sc_automobile_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(13)").html();
		var st_automobile_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(15)").html();
