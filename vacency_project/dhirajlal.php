...
<form action="save_data.php" id="save_data" method="POST">
	<input type="text" name="college" value="Dhirajlal">
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		//CSE
		var oc_cse_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(3)").html();
		var bcm_cse_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(5)").html();
		var bc_cse_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(7)").html();
		var mbc_cse_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(9)").html();
		var sca_cse_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(11)").html();
		var sc_cse_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(13)").html();
		var st_cse_engineering_value = $("table > tbody tr:nth-child(8) > td:nth-child(15)").html();
