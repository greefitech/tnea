...
<form action="save_data.php" id="save_data" method="POST">
	<input type="text" name="college" value="Mahendra4">
	...
	<input type="text" name="et_department" id="et_department">
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		...
		//et
		var oc_et_engineering_value = $("table > tbody tr:nth-child(12) > td:nth-child(3)").html();
		var bcm_et_engineering_value = $("table > tbody tr:nth-child(12) > td:nth-child(5)").html();
		var bc_et_engineering_value = $("table > tbody tr:nth-child(12) > td:nth-child(7)").html();
		var mbc_et_engineering_value = $("table > tbody tr:nth-child(12) > td:nth-child(9)").html();
		var sca_et_engineering_value = $("table > tbody tr:nth-child(12) > td:nth-child(11)").html();
		var sc_et_engineering_value = $("table > tbody tr:nth-child(12) > td:nth-child(13)").html();
		var st_et_engineering_value = $("table > tbody tr:nth-child(12) > td:nth-child(15)").html();

		$("#et_department").val(oc_et_engineering_value+"|"+bcm_et_engineering_value+"|"+bc_et_engineering_value+"|"+mbc_et_engineering_value+"|"+sca_et_engineering_value+"|"+sc_et_engineering_value+"|"+st_et_engineering_value);
