...
<form action="save_data.php" id="save_data" method="POST">
	<input type="text" name="college" value="Mahendra3">
...
<script type="text/javascript">
	...
	$(document).ready(function () {
		//bio_medical
		var oc_bio_medical_engineering_value = $("table > tbody tr:nth-child(6) > td:nth-child(3)").html();
		var bcm_bio_medical_engineering_value = $("table > tbody tr:nth-child(6) > td:nth-child(5)").html();
		var bc_bio_medical_engineering_value = $("table > tbody tr:nth-child(6) > td:nth-child(7)").html();
		var mbc_bio_medical_engineering_value = $("table > tbody tr:nth-child(6) > td:nth-child(9)").html();
		var sca_bio_medical_engineering_value = $("table > tbody tr:nth-child(6) > td:nth-child(11)").html();
		var sc_bio_medical_engineering_value = $("table > tbody tr:nth-child(6) > td:nth-child(13)").html();
		var st_bio_medical_engineering_value = $("table > tbody tr:nth-child(6) > td:nth-child(15)").html();

		$("#bio_medical_department").val(oc_bio_medical_engineering_value+"|"+bcm_bio_medical_engineering_value+"|"+bc_bio_medical_engineering_value+"|"+mbc_bio_medical_engineering_value+"|"+sca_bio_medical_engineering_value+"|"+sc_bio_medical_engineering_value+"|"+st_bio_medical_engineering_value);
		...
		//mechatronics
		var oc_mechatronics_engineering_value = $("table > tbody tr:nth-child(16) > td:nth-child(3)").html();
		var bcm_mechatronics_engineering_value = $("table > tbody tr:nth-child(16) > td:nth-child(5)").html();
		var bc_mechatronics_engineering_value = $("table > tbody tr:nth-child(16) > td:nth-child(7)").html();
		var mbc_mechatronics_engineering_value = $("table > tbody tr:nth-child(16) > td:nth-child(9)").html();
		var sca_mechatronics_engineering_value = $("table > tbody tr:nth-child(16) > td:nth-child(11)").html();
		var sc_mechatronics_engineering_value = $("table > tbody tr:nth-child(16) > td:nth-child(13)").html();
		var st_mechatronics_engineering_value = $("table > tbody tr:nth-child(16) > td:nth-child(15)").html();
